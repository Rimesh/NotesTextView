...
extension UIColor {
    static var grayBackgroundNormal: UIColor = UIColor { traitCollection -> UIColor in
    ...
    static var grayBackgroundSelected: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FETextRed: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FETextBlue: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FETextGreen: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FETextOrange: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FEHighlightOrange: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FEHighlightGreen: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FEHighlightBlue: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var FEHighlightRed: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
    ...
    static var notesBackground: UIColor = UIColor { traitCollection -> UIColor in
        if traitCollection.userInterfaceStyle == .dark {
            return .black
        } else {
